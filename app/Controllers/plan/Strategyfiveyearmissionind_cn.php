...
class Strategyfiveyearmissionind_cn extends BaseController
{
	public $m_name = 'plan/strategyfiveyearmissionind_m';
	...
	{	
		$this->unit_m = model($this->m_name);
		$result = $this->unit_m->search_mission_target_id();
		echo $result;
	}
	...
	{	
		$this->unit_m = model($this->m_name);
		$result = $this->unit_m->indicatorlvfour_id_add();
		echo $result;
	}
	public function search_plantargetlvfour_id()
	{	
		$this->unit_m = model($this->m_name);
		$result = $this->unit_m->search_plantargetlvfour_id();
		echo $result;
	}
