...
class Towsa_cn extends BaseController
{
	public $m_name = 'plan/towsa_m';
	...
	{	
		$this->unit_m = model($this->m_name);
		$result = $this->unit_m->loaddata_ex();
		echo $result;
	}
	...
	{	
		$this->unit_m = model($this->m_name);
		$result = $this->unit_m->search_structure_unit_id();
		echo $result;
	}
	public function search_structure_group_id()
	{	
		$this->unit_m = model($this->m_name);
		$result = $this->unit_m->search_structure_group_id();
		echo $result;
	}
