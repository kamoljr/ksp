          ...
          <ul class="columns">
            ...
            <li class="column to-do-column" >
              ...
              <ul class="task-list unit1" id="to-do" >
                <li class="task" value = '11'>
               
                  <p style = "padding-left:5px;">กลุ่มมาตรฐานการประกอบวิชาชีพ	11</p>
                ...
                <li class="task" value = '22'>
                  <p style = "padding-left:5px;">กลุ่มรับรองความรู้และความชำนาญ	22</p>
                  <div class="demo text-right" style="padding-top:5px;display:block">
                      <a href="javascript:void(0);" class="btn btn-outline-primary btn-xs btn-icon rounded-circle" style="margin-bottom:10px !important;">
                          <i class="ni ni-pencil"></i>
                      </a>
                ...
                <li class="task" value = '33'>
                  <p style = "padding-left:5px;">ทดสอบความรู้ในการประกอบวิชาชีพ	33</p>
                  <div class="demo text-right" style="padding-top:5px;display:block">
                      <a href="javascript:void(0);" class="btn btn-outline-primary btn-xs btn-icon rounded-circle" style="margin-bottom:10px !important;">
                          <i class="ni ni-pencil"></i>
                      </a>
                ...
                <li class="task" value = '44'>
                  <p style = "padding-left:5px;">กลุ่มรับรองปริญญาและประกาศนียบัตร 44	</p>
                  <div class="demo text-right" style="padding-top:5px;display:block">
                      <a href="javascript:void(0);" class="btn btn-outline-primary btn-xs btn-icon rounded-circle" style="margin-bottom:10px !important;">
                          <i class="ni ni-pencil"></i>
                      </a>
