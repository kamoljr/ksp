...
<div class="row">
    <div class="col-xl-12">
                        ...
                        <div id="js_list_accordion-a" class="collapse show" data-parent="#js_list_accordion">
                            <div class="card-body">
                                <form action="<?=$actual_link?>" method="post" accept-charset="utf-8" id="form-search"
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <label class="form-label" for="unit_name_search">กลุ่มงาน</label>
                                            
                                                <select id="unit_name_search" name="unit_name_search" class="select2" placeholder="กลุ่มงาน">
                                                    <option value="1">สำนักอำนวยการ</option>
                                                    <option value="2">สำนักนโยบายและแผน</option>
                                                    <option value="3">สำนักเทคโนโลยีสารสนเทศ</option>
                                                </select>
                                        </div>
                                        <div class="col-sm-6">
                                            <label class="form-label" for="group_name_search">ชื่อกลุ่มงาน</label>
                                            <input id="group_name_search" name="group_name_search"
                                                class="form-control searchdata" type="text" placeholder="ชื่อกลุ่มงาน" />
                                        </div>
                                    </div>
                                </form>
                            </div>
        ...
        <div class="alert alert-warning" id='searchresults' name='searchresults' style="margin-bottom: 15px;">ค้นหาโดย : สำนักอำนวยการ</div>
    </div>
</div>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="javascript:void(0);" class="btn btn-outline-danger btn-icon btn-xs rounded-circle waves-effect waves-themed"data-toggle="modal" data-target="#example-modal-alert" ><i class="ni ni-trash"></i></a>
                                </td>
                            </tr>
                        </tbody>
                    </table>
