            ...
            <div class="form-row dialog-data ">
              ...
              <div class="col-md-12 mb-12" style = "padding-bottom:10px;padding-right:10px;">
                <label class="form-label color-fusion-500" style ="" for="form_add_lbl_search_strategylvfour">
                  <h4>แผนปฏิบัติการระยะ 5 ปี : <label id = "form_add_lbl_search_strategylvfour"></label></h4>
              ...
              <div class="col-md-12 mb-12" style = "padding-bottom:25px;padding-left:10px;padding-right:10px;">
                <label class="form-label color-fusion-500" style ="font-weight:550;font-size:14px;" for="plantargetlvthree_id_add">
                  เชื่อมเป้าหมายแผนระดับ3
                  <span class="text-danger stars"> * </span>
                </label>
                <div id = "div_plantargetlvthree_id_add"></div>
              </div>
              <div class="col-md-12 mb-12" style = "padding-bottom:25px;">
                <label class="form-label color-fusion-500" style ="font-weight:550;font-size:14px;" for="plantargetlvfour_add">
                  เป้าหมายแผนปฏิบัติการระยะ 5 ปี
                  <span class="text-danger stars"> * </span>
                </label>
                <input type="text" class="form-control form-ele clear-element" id="plantargetlvfour_add" name="plantargetlvfour_add" placeholder="เป้าหมาย" value="" >
              </div> 
              <div class="col-md-12 mb-12" style = "padding-bottom:25px;">
                <label class="form-label color-fusion-500" style ="font-weight:550;font-size:14px;padding-left:10px;" for="plantargetlvfour_comment_add">
                  คำอธิบาย
                  <span class="text-danger stars">  </span>
                </label>
                <input type="text" class="form-control form-ele clear-element" id="plantargetlvfour_comment_add" name="plantargetlvfour_comment_add" placeholder="คำอธิบาย" value="" >
              </div> 
