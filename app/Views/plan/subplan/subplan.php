...
<div class="row">
  <div class="col-xl-12">
    ...
    style="margin-bottom: 15px;">
      ค้นหาโดย : แผนแม่บท ประเด็น 12 การพัฒนาการเรียนรู้ (พ.ศ. 2561-2580)
    </div>
  </div>
</div>
<div class="row">
                  ...
                  <div class="btn-group-vertical" role="group" aria-label="Vertical button group">
                    <div class="btn-group" role="group">
                        ...
                        <div class="dropdown-menu" aria-labelledby="btnGroupVerticalDrop1">
                            <a class="dropdown-item" href="plantargetsubplan">เป้าหมาย</a>
                            <a class="dropdown-item" href="indicatorsubplan">ตัวชี้วัด</a>
