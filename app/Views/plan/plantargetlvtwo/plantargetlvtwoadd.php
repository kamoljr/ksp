          ...
          <div class="panel-content">
            ...
            <div class="form-row dialog-data ">
              ...
              <div class="col-md-12 mb-12" style = "padding-bottom:25px;padding-left:10px;padding-right:10px;">
                ...
                <div id = "div_plantargetlvone_id_add"></div>
              </div>
              <div class="col-md-3 mb-3" style = "padding-bottom:0px;padding-left:10px;padding-right:10px;">
                <label class="form-label color-fusion-500" style ="font-weight:550;font-size:14px;" for="unit_name_add">
              ...
              <div class="col-md-9 mb-9" style = "padding-bottom:0px;padding-left:10px;padding-right:10px;">
                <label class="form-label color-fusion-500" style ="font-weight:550;font-size:14px;" for="unit_name_add">
                  ...
                  <h4><label id = "form_add_lbl_strategylvtwo"></label></h4>
                  <span class="text-danger stars">  </span>
                </label>
              </div> 
              
              <div class="col-md-12 mb-12" style = "padding-bottom:25px;">
                <label class="form-label color-fusion-500" style ="font-weight:550;font-size:14px;padding-left:10px;" for="plantargetlvtwo_add">
                  เป้าหมายแผนระดับ2
                  <span class="text-danger stars"> * </span>
                </label>
                <input type="text" class="form-control form-ele clear-element" id="plantargetlvtwo_add" name="plantargetlvtwo_add" placeholder="เป้าหมายแผนระดับ2" value="" >
              </div> 
              <div class="col-md-12 mb-12" style = "padding-bottom:25px;">
                <label class="form-label color-fusion-500" style ="font-weight:550;font-size:14px;padding-left:10px;" for="plantargetlvtwo_comment_add">
                  คำอธิบาย
                  <span class="text-danger stars"></span>
                </label>
                <input type="text" class="form-control form-ele clear-element" id="plantargetlvtwo_comment_add" name="plantargetlvtwo_comment_add" placeholder="คำอธิบาย" value="" >
              </div> 
