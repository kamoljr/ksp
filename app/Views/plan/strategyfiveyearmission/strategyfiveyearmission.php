...
<div class="row">
  <div class="col-xl-12">
    ...
    style="margin-bottom: 15px;">
      ค้นหาโดย : แผนยุทธศาสตร์คุรุสภา 5 ปี 2566-2570
    </div>
  </div>
</div>
<div class="row">
...
<!--                
            ...
            <tbody>
              <tr>
                ...
                <!-- <td>
                  <button type="button" class="btn btn-xs btn-primary" onclick="window.location='strategyfiveyearobj';">วัตถุประสงค์</button>
                </td>
