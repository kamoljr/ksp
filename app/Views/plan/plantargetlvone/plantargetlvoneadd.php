          ...
          <div class="panel-content">
            ...
            <div class="form-row dialog-data ">
              ...
              <div class="col-md-12 mb-12" style = "padding-bottom:10px;padding-right:10px;">
                <label class="form-label color-fusion-500" style ="" for="">
                  <h4>แผนยุทธศาสตร์ชาติ : <label id = "form_add_lbl_strategylvone">ด้านการพัฒนาและเสริมสร้างศักยภาพทรัพยากรมนุยษ์</h4>
              ...
              <div class="col-md-12 mb-12" style = "padding-bottom:25px;">
                ...
                <input type="text" class="form-control form-ele clear-element" id="plantargetlvone_add" name="plantargetlvone_add" placeholder="เป้าหมายแผนยุทธศาสตร์ชาติ" value="" >
              </div> 
              <div class="col-md-12 mb-12" style = "padding-bottom:25px;">
                ...
                <input type="text" class="form-control form-ele clear-element" id="plantargetlvone_comment_add" name="plantargetlvone_comment_add" placeholder="คำอธิบาย" value="" >
              </div> 
