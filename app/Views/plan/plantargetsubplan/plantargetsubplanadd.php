          ...
          <div class="panel-content">
            ...
            <div class="form-row dialog-data ">
              ...
              <div class="col-md-12 mb-12" style = "padding-bottom:25px;padding-left:10px;padding-right:10px;">
                ...
                <select id="subplan_add" name="subplan_add" class="select2"
                      placeholder="แผนย่อย">
              ...
              <div class="col-md-12 mb-12" style = "padding-bottom:25px;padding-left:10px;padding-right:10px;">
                <label class="form-label color-fusion-500" style ="font-weight:550;font-size:14px;" for="unit_name_add">
                  เชื่อมเป้าหมายแผนแม่บท
                  <span class="text-danger stars"> * </span>
                </label>
                <select id="group_name_add" name="group_name_add" class="select2" placeholder="ส่วนงาน">
                   <option>	คนไทยมีการศึกษาที่มีคุณภาพตามมาตรฐานสากลเพิ่ม มีทักษะท่ี จำเป็นของโลกศตวรรษที่ ๒๑ สามารถแก้ปัญหา ปรับตัว สื่อสาร และทำงานร่วมกับผู้อื่นได้อย่างมีประสิทธิผล เพิ่มขึ้น มีนิสัยใฝ่เรียนรู้อย่างต่อเนื่องตลอดชีวิต</option>
                </select>
              </div>
