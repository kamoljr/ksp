...
<div class="row">
  <div class="col-xl-12">
              ...
              <div class="card-body">
                ...
                id="form-search" name="form-search">
                  <div class="row">
                    ...
                    <div class="col-sm-6">
                      <label class="form-label" for="subplan_search">
                         แผนย่อย
                      </label>
                      <select id="subplan_search" name="subplan_search" class="select2"
                      placeholder="แผนย่อย">
    ...
    style="margin-bottom: 15px;">
      ค้นหาโดย : แผนแม่บท <u>ประเด็น 12 การพัฒนาการเรียนรู้ (พ.ศ. 2561-2580)</u> แผนย่อย <u>การปฏิรูปกระบวนการเรียนรู้ที่ตอบสนองต่อการเปลี่ยนแปลงในศตวรรษที่ 21</u>
    </div>
  </div>
</div>
<div class="row">
          ...
          <table id="dynamic-table" class="table table-md table-bordered table-hover table-striped w-100">
            ...
            <tbody>
              <tr>
                ...
                <td>
                  คนไทยมีการศึกษาที่มีคุณภาพตามมาตรฐาน มีทักษะการเรียนรู้ และทักษะที่จำเป็นของโลกศตวรรษที่ ๒๑ สามารถเข้าถึงการเรียนรู้อย่างต่อเนื่องตลอดชีวิตดีขึ้น
                </td>
                <td>
