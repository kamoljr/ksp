        ...
        <div class="panel-container show">
          <div class="panel-content">
            ...
            <div class="form-row dialog-data ">
              ...
              <div class="col-md-12 mb-12" style = "padding-bottom:10px;padding-right:10px;">
                <label class="form-label color-fusion-500" style ="" for="unit_name_add">
                  <h4>เป้าหมายแผนยุทธศาสตร์ชาติ : <label id ="form_add_lbl_plantargetlvone"></label></h4>
                  
                </label>
              </div> 
              <div class="col-md-12 mb-12" style = "padding-bottom:25px;">
                <label class="form-label color-fusion-500" style ="font-weight:550;font-size:14px;" for="indicatorlvone_add">
                  ตัวชี้วัดแผนยุทธศาสตร์ชาติ
                  <span class="text-danger stars"> * </span>
                </label>
                <input type="text" class="form-control form-ele clear-element" id="indicatorlvone_add" name="indicatorlvone_add" placeholder="ตัวชี้วัด" value="" >
              </div> 
              <div class="col-md-12 mb-12" style = "padding-bottom:25px;">
                <label class="form-label color-fusion-500" style ="font-weight:550;font-size:14px;padding-left:10px;" for="indicatorlvone_unit_add">
                  หน่วย
                  <span class="text-danger stars"> * </span>
                </label>
                <input type="text" class="form-control form-ele clear-element" id="indicatorlvone_unit_add" name="indicatorlvone_unit_add" placeholder="หน่วย" value="" >
              </div>
