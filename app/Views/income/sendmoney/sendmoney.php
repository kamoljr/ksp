              ...
              <tr>
                ...
                <td>
                  <div class="custom-control custom-checkbox d-block bg-success-800" style="padding-left:0px;padding-right:0px;margin:0px;padding-bottom:0px;padding-top:4px;">
                      <label><small class="">นำส่งเงินแล้ว</small></label>
                  </div>
                </td>
                <td>
                  <a href="javascript:void(0);" ${txtex} class="btn btn-outline-success btn-icon btn-xs rounded-circle waves-effect waves-themed edit-data" mode='view' data-toggle="modal" data-target=".default-example-modal-right">
                    <i class="ni ni-eye">
                    </i>
                  </a>
