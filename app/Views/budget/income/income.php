...
<div class="row">
  <div class="col-xl-12">
                ...
                id="form-search" name="form-search">
                  <div class="row">
                    ...
                    <div class="col-sm-6">
                      ...
                      <select id="income_search" name="income_search" class="select2"
    ...
    style="margin-bottom: 15px;">
      ค้นหาโดย : <u>ปีงบประมาณ</u> 2566 <u>ประเภทรายรับ</u> ค่าธรรมเนียมตามพระราชบัญญัตินี้
    </div>
  </div>
</div>
<div class="row">
          ...
          <table id="dynamic-table" class="table table-md table-bordered table-hover table-striped w-100">
            ...
            <tbody>
              <tr>
                ...
                <td>
                  	ค่าธรรมเนียมขึ้นทะเบียนรับใบอนุญาตประกอบวิชาชีพ	
                </td>
                <td>
                 20,000,000	
                </td>
              ...
              <tr>
                ...
                <td>
                  	ค่าธรรมเนียมต่อใบอนุญาตประกอบวิชาชีพ	
                </td>
                <td>
                 13,000,000	
                </td>
