          ...
          <div class="panel-content">
            ...
            <div class="form-row dialog-data ">
              ...
              <div class="col-md-12 mb-12 col_add">
                ...
                <select id="expend_add" name="expend_add" class="" placeholder="รายการค่าใช้จ่าย">
                    <option value="">เงินเดือนพนักงานเจ้าหน้า</option>
                    <option value="">เงินเดือนเลขาธิการฯ</option>
                    <option value="">เงินเดือนรองเลขาธิการคุรุสภา</option>
                    <option value="">เลื่อนเงินเดือน</option>
                </select>
              </div> 
              <div class="col-md-12 mb-12" style = "padding-bottom:25px;">
              ...
              <div class="col-md-6 mb-6" style = "padding-bottom:0px;">
                ...
                <input type="text" class="form-control form-ele clear-element" id="grfoup_name_add" name="groufp_name_add" placeholder="จำนวนเงินอุดหนุน" value="" >
              </div> 
              <div class="col-md-6 mb-6" style = "padding-bottom:0px;">
                <label class="form-label color-fusion-500" style ="font-weight:550;font-size:14px;" for="group_name_add">
                  จำนวนเงินนอกงบประมาณ
                  <span class="text-danger stars"> * </span>
                </label>
                <input type="text" class="form-control form-ele clear-element" id="grfoup_name_add" name="groufp_name_add" placeholder="จำนวนเงินนอกงบประมาณ" value="" >
              </div> 
              <div class="col-md-12 mb-12" style = "padding-bottom:0px;">
                <label class="form-label color-fusion-500" style ="font-weight:550;" for="group_name_add">
                    <h4>จำนวนเงินรวม : 1,000,000 บาท<h4>
                  <span class="text-danger stars">  </span>
                </label>
                <!-- <input type="text" class="form-control form-ele clear-element" id="group_name_add" name="group_name_add" placeholder="แผนงาน" value="" > -->
              </div> 
