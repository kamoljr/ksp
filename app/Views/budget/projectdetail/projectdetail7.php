          ...
          <div class="panel-content">
            ...
            <div class="form-row dialog-data" style = "">
              ...
              <div class="col-md-12 mb-12 text-center" style = "padding-bottom:15px;text-align:certer;">
                <span class="h4 font-weight-bold text-uppercase">ส่งโครงการ</span>
              </div>
              ...
              <div class="col-md-12 mb-12" style = "padding-bottom:25px;">
                <label class="form-label color-fusion-500" style ="font-weight:550;font-size:14px;padding-bottom:5px;" for="group_name_add">
                  ...
                  <select id="plans_search" name="plans_search" class="select2" placeholder="สถานะ">
                    <option value="">
                      ระหว่างดำเนินการ
                    </option>
                    <option value="17">
              ...
              <div class="col-md-12 mb-12" style = "padding-bottom:25px;">
                <label class="form-label color-fusion-500" style ="font-weight:550;font-size:14px;" for="group_name_add">
                  รายละเอียดสาเหตุการตีกลับ
                  <span class="text-danger stars"> * </span>
                </label>
                <textarea class="form-control" id="example-textarea" rows="2" placeholder="รายละเอียดสาเหตุการตีกลับ"></textarea>
              </div>
