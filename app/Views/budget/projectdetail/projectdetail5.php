      ...
      <div id="panel-2" class="panel">
        <div class="panel-container show">
          ...
          <div class="col-md-12 mb-12 text-center" style = "padding-bottom:0px;text-align:certer;">
            <span class="h4 font-weight-bold text-uppercase">เป้าหมายเชิงคุณภาพ</span>
          </div>
          ...
          <div class="frame-wrap mt-3 mb-0 w-100" style="padding-bottom: 15px;">
            <button id="btnadd" type="button" class="btn btn-primary btnadd" value = "target2" data-toggle="modal"
            data-target=".default-example-modal-right" style="display: flex;">
              <span class="ni ni-big-plus fa-2x" style="padding-right:10px;">
              </span>
              <span style="padding-top:5px;">
                เพิ่มเป้าหมายเชิงคุณภาพ
              </span>
            </button>
          </div>
         
          <table id="dynamic-table5" class="table table-md table-bordered table-hover table-striped w-100">
            <thead class="bg-primary-600">
              <tr>
                <th class="text-center" width = "10px;" ></th>
                <th class="text-center" >เป้าหมายเชิงคุณภาพ</th>
                <th width="110">ค่าเป้าหมาย</th>
            ...
            <tbody>
              <tr>
                <td>1</td>
                <td>แนวทางทางการดําเนินงานพัฒนา สถาบันคุรุพัฒนาสู่การเป็นราชวิทยาลัยครู และบุคลากรทางการศึกษาแห่งประเทศไทย ได้รับการพิจารณาจากคุรุสภา</td>
                <td>1</td>
                <td>ครั้ง</td>
                <td>
              ...
              <tr>
                <td>2</td>
                <td>ผู้เข้ารับการอบรมมาตรฐานความรู้วิชาชีพครู เป็นผู้มีความรู้ตามมาตรฐานและ จรรยาบรรณของวิชาชีพร้อยละ </td>
                <td>75</td>
                <td>ร้อยละ</td>
                <td>
                  <a href="javascript:void(0);" ${txtex} class="btn btn-outline-success btn-icon btn-xs rounded-circle waves-effect waves-themed edit-data"
              ...
              <tr>
                <td>3</td>
                <td>นวัตกรรมการพัฒนาสมรรถนะผู้ประกอบวิชาชีพ ทางการศึกษาขั้นสูงได้รับการเผยแพร่</td>
                <td>1</td>
                <td>ครั้ง</td>
                <td>
                  <a href="javascript:void(0);" ${txtex} class="btn btn-outline-success btn-icon btn-xs rounded-circle waves-effect waves-themed edit-data"
