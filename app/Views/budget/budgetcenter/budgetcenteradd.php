          ...
          <div class="panel-content">
            ...
            <div class="form-row dialog-data ">
              ...
              <div class="col-md-12 mb-12" style = "padding-bottom:25px;">
                ...
                <input type="text" class="form-control form-ele clear-element" id="group_name_add" name="group_name_add" placeholder="รายการ" value="" >
              </div> 
              <div class="col-md-12 mb-12" style = "padding-bottom:25px;">
                <label class="form-label color-fusion-500" style ="font-weight:550;font-size:14px;" for="group_name_add">
                  คำชี้แจง
                ...
                <input type="text" class="form-control form-ele clear-element" id="grfoup_name_add" name="groufp_name_add" placeholder="รายการ" value="" >
              </div> 
              ...
              <div class="col-md-12 mb-12 col_add">
                ...
                <select id="groupnameadd" name="groupnameadd" class="" placeholder="กลุ่มงาน">
                  <option value="">
                    เลือกกลุ่มงาน
                  </option>
                  <option value="17">
              ...
              <div class="col-md-6 mb-6" style = "padding-bottom:25px;">
                <label class="form-label color-fusion-500" style ="font-weight:550;font-size:14px;" for="group_name_add">
                  จำนวนเงินในงบประมาณ
                  <span class="text-danger stars"> * </span>
                </label>
