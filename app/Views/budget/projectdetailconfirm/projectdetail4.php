      ...
      <div id="panel-2" class="panel">
        <div class="panel-container show">
          ...
          <div class="col-md-12 mb-12 text-center" style = "padding-bottom:0px;text-align:certer;">
            <span class="h4 font-weight-bold text-uppercase">เป้าหมายเชิงปริมาณ</span>
          </div>
          ...
          <table id="dynamic-table4" class="table table-md table-bordered table-hover table-striped w-100">
            ...
            <tbody>
              <tr>
                ...
                <td>ฉบับ</td>
                <td>
                  <a href="javascript:void(0);" ${txtex} class=" btnadd btn btn-outline-success btn-icon btn-xs rounded-circle waves-effect waves-themed edit-data"
                  mode='view' data-value = "target1" data-toggle="modal"
