...
<div class="row">
  <div class="col-xl-12">
                ...
                id="form-search" name="form-search">
                  <div class="row">
                    ...
                    <div class="col-sm-4">
                      ...
                      placeholder="กิจการลูก">
                        <option value="" selected>
                          กองทุนสวัสดิการมและกองทุนบำเน็จ
                        </option>
                        <option value="17">
                          กองทุนพัฒนาและผดุงเกียรติวิชาชีพ
                        </option>
                        <option value="17">
                          ข้อมูลกิจการของมูลนิธิรายการที่ 1
                        </option>
                        <option value="17">
                          ข้อมูลกิจการของมูลนิธิรายการที่ 2
                        </option>
    ...
    style="margin-bottom: 15px;">
      ค้นหาโดย : <u>ปีงบประมาณ</u> 2566 <u>กิจการลูก</u> กองทุนสวัสดิการมและกองทุนบำเน็จ
    </div>
  </div>
</div>
