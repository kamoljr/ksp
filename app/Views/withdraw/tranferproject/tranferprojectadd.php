      ...
      <div id="panel-2" class="panel">
        <div class="panel-container show " style = "color:#666666;">
          <div class="panel-content" style = "padding:8px;">
            ...
            <div class="panel-content fourd-form-row-c" >
              <div class="form-row dialog-data " style = "padding-bottom:0px;">
                <div class="col-md-2 mb-2" style="padding-bottom:0px;font-weight:550;font-size:13px;margin-bottom:0px !important;line-height:25px;">
                  <label class="form-label" for="" style = "margin:0;">
                   เลือกรายการ<br>ที่ยินยอมให้โอน
                  </label>
                </div>
                <div class="col-md-10 mb-10" style="padding-top:0px;padding-bottom:0px;font-size:13px;margin-bottom:0px !important;">
                 <div class="">
                    <div class="custom-control custom-radio custom-control-inline" style ="line-height:25px;vertical-align: middle;">
                        <input type="radio" class="custom-control-input" id="givetype1" name="givetype"  style = "margin-top:15px;" checked value = "1">
                        <label class="custom-control-label " for="givetype1" >งาน/โครงการ</label>
                    </div>
                    <div class="custom-control custom-radio custom-control-inline" style ="line-height:25px;vertical-align: middle;">
                        <input type="radio" class="custom-control-input" id="givetype2" name="givetype" value = "2">
                        <label class="custom-control-label " for="givetype2">งบบุคลากร</label>
                    </div>
                    <div class="custom-control custom-radio custom-control-inline" style ="line-height:25px;vertical-align: middle;">
                        <input type="radio" class="custom-control-input" id="givetype3" name="givetype" value = "3">
                        <label class="custom-control-label " for="givetype3">งบกลาง</label>
                    </div>
            ...
            <div id = "expend_row_id0"class="panel-content fourd-form-row-c" style = "text-align:center !important;">
