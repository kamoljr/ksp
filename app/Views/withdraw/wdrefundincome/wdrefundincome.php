...
<div class="row">
  <div class="col-xl-12">
                ...
                id="form-search" name="form-search">
                  <div class="row">
                    ...
                    <div class="col-sm-2">
                      ...
                      <select id="income_type_search" name="income_type_search" class="select2"
                      placeholder="ขอคืนเงินรายได้">
    ...
    style="margin-bottom: 15px;">
      ค้นหาโดย : <u>ปีงบประมาณ</u> 2566 <u>ประเภทรายรับ</u> ค่าธรรมเนียมตามพระราชบัญญัตินี้	<u>ขอคืนเงินรายได้</u> ค่าธรรมเนียมต่อใบอนุญาตประกอบวิชาชีพ(42102)		
    </div>
  </div>
</div>
              ...
              <div class="row">
                ...
                <div class="col-sm-2 custom-control-inline text-center" style = "padding:0px;margin:0px;">
                  <div class="custom-control custom-checkbox d-block" style = "padding:0px;margin:0px;">
                      ...
                      <small>ส่งขอคืนเงินรายได้</small>
                  </div>
                </div>
                <div class="col-sm-2 custom-control-inline text-center" style = "padding:0px;margin:0px;">
                  <div class="custom-control custom-checkbox d-block" style = "padding:0px;margin:0px;">
                ...
                <div class="col-sm-2 custom-control-inline text-center" style = "padding:0px;margin:0px;">
                  <div class="custom-control custom-checkbox d-block" style = "padding:0px;margin:0px;">
                      ...
                      <small>ปิดขอคืนเงินรายได้</small>
                  </div>
                </div>
