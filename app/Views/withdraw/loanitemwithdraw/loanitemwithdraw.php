...
<div class="row">
  <div class="col-xl-12">
                ...
                id="form-search" name="form-search">
                  <div class="row">
                    ...
                    <div class="col-sm-4">
                      ...
                      placeholder="เงินให้กู้ยืม">
                        <option value="" selected>
                          ข้อมูลเงินให้กู้ยืมรายการที่ 1
                        </option>
                        <option value="" >
                          ข้อมูลเงินให้กู้ยืมรายการที่ 2
                        </option>
                        <option value="" >
                          ข้อมูลเงินให้กู้ยืมรายการที่ 3
                        </option>
    ...
    style="margin-bottom: 15px;">
      ค้นหาโดย : <u>ปีงบประมาณ</u> 2566 <u>เงินให้กู้ยืม</u> ข้อมูลเงินให้กู้ยืมรายการที่ 1
    </div>
  </div>
</div>
