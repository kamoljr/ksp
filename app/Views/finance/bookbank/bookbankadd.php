          ...
          <div class="panel-content">
            ...
            <div class="form-row dialog-data ">
              ...
              <div class="col-md-6 mb-6" style = "">
                ...
                <input type="text" class="form-control form-ele clear-element" id="group_name_add" name="group_name_add" placeholder="ชื่อธนาคาร" value="" >
              </div> 
              <div class="col-md-6 mb-6" style = "">
                <label class="form-label color-fusion-500" style ="font-weight:550;font-size:14px;" for="group_name_add">
                  ชื่อบัญชี
              ...
              <div class="col-md-6 mb-6" style = "">
                ...
                <input type="text" class="form-control form-ele clear-element" id="group_name_add" name="group_name_add" placeholder="สาขา" value="" >
              </div> 
              <div class="col-md-6 mb-6" style = "">
                <label class="form-label color-fusion-500" style ="font-weight:550;font-size:14px;" for="group_name_add">
                  ประเภท
              ...
              <div class="col-md-6 mb-6" style = "">
                ...
                <input type="text" class="form-control form-ele clear-element datepk" id="testdate" name="testdate" placeholder="วันที่เปิดบัญชี" value="" >
              </div> 
              <div class="col-md-6 mb-6" style = "">
                <label class="form-label color-fusion-500" style ="font-weight:550;font-size:14px;" for="group_name_add">
                  ยอดยกมา (บาท)
                ...
                <input type="text" class="form-control form-ele clear-element" id="group_name_add" name="group_name_add" placeholder="ยอดยกมา" value="" >
              </div> 
              <div class="col-md-6 mb-6" style = "">
                <label class="form-label color-fusion-500" style ="font-weight:550;font-size:14px;" for="group_name_add">
                  ยอดยกมา ณ วันที่
                ...
                <input type="text" class="form-control form-ele clear-element datepk" id="testdate1" name="testdate2" placeholder="ยอดยกมา ณ วันที่" value="" >
              </div> 
              <!-- <div class="col-md-6 mb-6" style = "">
