          ...
          <div class="panel-content">
            ...
            <div class="form-row dialog-data ">
              ...
              <div class="col-md-12 mb-12" style = "padding-bottom:25px;">
                ...
                <input type="text" class="form-control form-ele clear-element datepk" id="group_name_add" name="group_name_add" placeholder="วันที่" value="" >
              </div> 
              <div class="col-md-12 mb-12" style = "padding-bottom:25px;">
                <label class="form-label color-fusion-500" style ="font-weight:550;font-size:14px;" for="group_name_add">
                  หมายเหตุ
                ...
                <input type="text" class="form-control form-ele clear-element " id="group_name_add" name="group_name_add" placeholder="หมายเหตุ" value="" >
              </div> 
              <!-- <div class="col-md-12 mb-12" style = "padding-bottom:25px;">
