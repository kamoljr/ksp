            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                  ...
                  <input type="hidden" id="textToCopy" value="http://<?=$ip_apps?>/public/loginktb.html?1">
                </td>
                <td>
                  <a href="javascript:void(0);" class="btn btn-primary btn-sm btn-icon" data-toggle="tooltip" data-placement="top" title="" data-original-title="http://<?=$ip_apps?>/public/loginktb.html?1" onClick="copyurl();">
                ...
                <td>
                  <button type="button" class="btn btn-xs btn-primary" onclick="window.location='listofboard';">รายชื่อ</button>
                </td>
              ...
              <tr>
                ...
                <td>
                <a href="javascript:void(0);" class="btn btn-primary btn-sm btn-icon" data-toggle="tooltip" data-placement="top" title="" data-original-title="http://<?=$ip_apps?>/public/loginktb.html?2" onClick="copyurl();">
                     <i class="fa-regular fa-copy"></i>
                  </a>
                </td>
                <td>
              ...
              <tr>
                ...
                <td>
                  ...
                  <a href="javascript:void(0);" class="btn btn-primary btn-sm btn-icon" data-toggle="tooltip" data-placement="top" title="" data-original-title="http://<?=$ip_apps?>/public/loginktb.html?3" onClick="copyurl();">
                     <i class="fa-regular fa-copy"></i>
                  </a>
