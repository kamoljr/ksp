          ...
          <div class="panel-content">
            ...
            <div class="form-row dialog-data ">
              ...
              <div class="col-md-12 mb-12" style = "padding-bottom:15px;">
                ...
                <input type="text" class="form-control form-ele clear-element" id="sss" name="sss" placeholder="เงินให้กู้ยืม" value="" >
              </div> 
              <div class="col-md-6 mb-6" style = "">
                <label class="form-label color-fusion-500" style ="font-weight:550;font-size:14px;" for="group_name_add">
                  ส่วนงาน
                ...
                <select id="unit_name_add" name="unit_name_add" class="select2"
                      placeholder="ส่วส่วนงานนงาน">
                        <option value="">
                          ทั้งหมด
                        </option>
                        <option value="17">
              ...
              <div class="col-md-6 mb-6" style = "">
                ...
                <select id="group_names_add" name="group_names_add" class=""
              ...
              <div class="col-md-6 mb-6" style = "">
                <label class="form-label color-fusion-500" style ="font-weight:550;font-size:14px;" for="tv">
                  จำนวนเงิน (บาท)
                  <span class="text-danger stars"> * </span>
                </label>
                <input type="text" class="form-control form-ele clear-element" id="tv" name="tv" placeholder="จำนวนเงิน" value="" >
              </div> 
              <div class="col-md-6 mb-6" style = "">
                <label class="form-label color-fusion-500" style ="font-weight:550;font-size:14px;" for="bank_type_add">
                  ประเภทเงิน
                  <span class="text-danger stars"> * </span>
                </label>
                <select id="bank_type_add" name="bank_type_add" class="select2"
                      placeholder="ประเภท">
              ...
              <div class="col-md-6 mb-6" style = "">
                <label class="form-label color-fusion-500" style ="font-weight:550;font-size:14px;" for="delivery_type_add">
                  ออกใบนำส่ง
                  <span class="text-danger stars"> * </span>
                </label>
                <select id="delivery_type_add" name="delivery_type_add" class="select2"
                      placeholder="ออกใบนำส่ง">
              ...
              <div class="col-md-6 mb-6" style = "">
                <label class="form-label color-fusion-500" style ="font-weight:550;font-size:14px;" for="type_bil_add">
                  รายการค่าใช้จ่าย
                  <span class="text-danger stars"> * </span>
                </label>
                <select id="type_bil_add" name="type_bil_add" class="select2"
                      placeholder="ออกใบนำส่ง">
