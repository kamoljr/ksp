...
<header class="page-header" role="banner">
    ...
    <div class="page-logo">
        <a href="#" class="page-logo-link press-scale-down d-flex align-items-center position-relative"
            ...
            <img src="<?= base_url().'/';?>img/logoksp.png" alt="สำนักงานเลขาธิการคุรุสภา" aria-roledescription="logo">
            ...
            <img src="/img/logo.png" style = 'width:50px;' alt="SmartAdmin WebApp" aria-roledescription="logo">

            <span class="page-logo-text mr-1 kspname" style="font-size:13px;">สำนักงานเลขาธิการคุรุสภา</span>
            <!-- <i class="fal fa-angle-down d-inline-block ml-1 fs-lg color-primary-300"></i> -->
