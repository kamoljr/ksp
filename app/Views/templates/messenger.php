                ...
                <div class="d-flex flex-row align-items-center mt-1 mb-1 color-white">
                    ...
                    <div class="info-card-text">
                        <a href="<?= base_url().'/';?>javascript:void(0);"
                            class="fs-lg text-truncate text-truncate-lg text-white" data-toggle="dropdown"
                            aria-expanded="false">
                            Tracey Chang
                            <i class="fal fa-angle-down d-inline-block ml-1 text-white fs-md"></i>
                        </a>
                        <div class="dropdown-menu">
                            <a class="dropdown-item" href="<?= base_url().'/';?>#">Send Email</a>
                            <a class="dropdown-item" href="<?= base_url().'/';?>#">Create Appointment</a>
                            <a class="dropdown-item" href="<?= base_url().'/';?>#">Block User</a>
                        </div>
                ...
                <div class="msgr d-flex h-100 flex-column bg-white">
                    ...
                    <div class="d-flex flex-column">
                        ...
                        <div class="height-8 px-3 d-flex flex-row align-items-center flex-wrap flex-shrink-0">
                            ...
                            <a href="<?= base_url().'/';?>javascript:void(0);" class="btn btn-icon fs-xl mr-1"
                            ...
                            <div class="ml-auto">
                                <a href="<?= base_url().'/';?>javascript:void(0);" class="btn btn-info">Send</a>
                            </div>
                        </div>
                    </div>
                    <!-- END msgr__chatinput -->
