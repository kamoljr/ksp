                  ...
                  <div class="btn-group-vertical" role="group" aria-label="Vertical button group">
                    <div class="btn-group" role="group">
                        ...
                        <div class="dropdown-menu" aria-labelledby="btnGroupVerticalDrop1">
                            <a class="dropdown-item" href="plantargetlvone" data-toggle="modal" data-target=".default-example-modal-right" onclick="opendialog(1)">รายงานผลโครงกร</a>
                            <a class="dropdown-item" href="actoverview">รายงานผลกิจกรรม</a>
                            <a class="dropdown-item" href="pointlvone" data-toggle="modal" data-target=".default-example-modal-right" onclick="opendialog(2)">แนปไฟล์เอกสาร</a>
                            <a class="dropdown-item" href="pointlvone" data-toggle="modal" data-target=".default-example-modal-right" onclick="opendialog(3)">ขอแก้ไข</a>
                        </div>
                    </div>
                  </div>
