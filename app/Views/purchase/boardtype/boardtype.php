...
<div class="row">
  <div class="col-xl-12">
                ...
                id="form-search" name="form-search">
                  <div class="row">
                    ...
                    <div class="col-sm-12">
                      ...
                      <input type="text" class="form-control form-ele clear-element" id="group_name_add" name="group_name_add" placeholder=" ประเภทคณะกรรมการ" value="" >
    ...
    style="margin-bottom: 15px;">
      ค้นหาโดย : ประเภทคณะกรรมการ ทั้งหมด
    </div>
  </div>
</div>
<div class="row">
