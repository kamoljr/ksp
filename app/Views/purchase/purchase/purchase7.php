<div class = "hidedivpurchase" id = "purchase7">
...
<div class="form-row dialog-data " style = "padding-bottom:0px;line-height:30px;vertical-align: middle;padding-top:0px !important;">
			<div class="col-sm-12 sm-12" style="padding-top:0px !important;font-weight:550;font-size:13px;margin-bottom:0px !important;">
				...
				<button type="button" class="btn btn-sm btn-default" data-toggle="modal" data-target="#purchase7-modal"><i class="fa-solid fa-plus"></i></button>
...
<div class="modal fade" id="purchase7-modal" tabindex="-1" role="dialog" aria-hidden="true">
		<div class="modal-dialog modal-lg modal-dialog-centered" role="document">
				<div class="modal-content">
						<div class="modal-header bg-primary text-white" style = "padding-top:5px;padding-bottom:5px;">
								<h5 class="modal-title">งวดงาน</h5>
						...
						<div class="panel-content fourd-form-row-a" >
							<div class="form-row dialog-data " style = "padding-bottom:5px;line-height:30px;vertical-align: middle;padding-top:5px;">
								...
								<div class="col-md-3 mb-3" style="padding-top:0px;padding-bottom:0px;font-size:13px;margin-bottom:0px !important;">
									<input type="text" class="form-control form-ele clear-element" id="position_name" name="position_name" placeholder="งวดที่" value="">
									<!-- <select id="purchase5_select_add" name="purchase5_select_add" class="ele_select_add" placeholder="บริษัทที่ได้รับเลือก">
						...
						<div class="panel-content fourd-form-row-b" >
							<div class="form-row dialog-data " style = "padding-bottom:8px;line-height:30px;vertical-align: middle;padding-top:5px;">
								<div class="col-md-3 mb-3" style="padding-bottom:0px;font-weight:550;font-size:13px;margin-bottom:0px !important;">
									<label class="form-label" for="" style = "margin:0;">
										ผู้รับจ้างได้ดำเนินการ 	
									</label>
								...
								<div class="col-md-9 mb-9" style="padding-top:0px;padding-bottom:0px;font-size:13px;margin-bottom:0px !important;">
									...
									<input type="text" class="form-control form-ele clear-element" id="position_name" name="position_name" placeholder="ผู้รับจ้างได้ดำเนินการ" value="">
								</div>
								...
								<div class="col-md-3 mb-3" style="padding-top:0px;padding-bottom:0px;font-size:13px;margin-bottom:0px !important;">
									<input type="text" class="form-control form-ele clear-element" id="position_name" name="position_name" placeholder="ให้แล้วเสร็จภายใน" value="">
						...
						<div class="panel-content fourd-form-row-a" >
							<div class="form-row dialog-data " style = "padding-bottom:5px;line-height:30px;vertical-align: middle;padding-top:5px;">
								...
								<div class="col-md-3 mb-3" style="padding-top:0px;padding-bottom:0px;font-size:13px;margin-bottom:0px !important;">
									<input type="text" class="form-control form-ele clear-element" id="position_name" name="position_name" placeholder="จำนวนวัน" value="">
								</div>
						...
						<!-- <div class="panel-content fourd-form-row-b" >
							<div class="form-row dialog-data " style = "padding-bottom:5px;line-height:30px;vertical-align: middle;padding-top:5px;">
								...
								<div class="col-md-2 mb-2" style="padding-top:0px;padding-bottom:0px;font-size:13px;margin-bottom:0px !important;">
									<input type="text" class="form-control form-ele clear-element" id="position_name" name="position_name" placeholder="ข้อสัญญา" value="">
								</div>
								<div class="col-md-3 mb-3" style="padding-top:0px;padding-bottom:0px;font-size:13px;margin-bottom:0px !important;">
              ...
              <div class="form-row dialog-data " style = "padding-bottom:0px;">
                <div class="col-sm-5 sm-5" style="padding-bottom:0px;font-weight:550;font-size:13px;margin-bottom:0px !important;">
                  ...
                  <select id="exp_type_add0" name="exp_type_add0" class="selectdialog addexpend ele_select_add" style = "100%" placeholder="รายการ">
                    <option value="" selected>
                      -
                    </option>
                    <option value="2">
                      ค่าจัดพิมพ์หนังสือและอื่น ๆ (54050-00)
                    </option>
                ...
                <div class="col-sm-2 sm-2" style="padding-top:5px;padding-bottom:0px;font-size:13px;margin-bottom:0px !important;">
                  ...
                  <input type="text" class="form-control form-ele clear-element" id="position_name" name="position_name" placeholder="จำนวน" value="">
						...
						<div class="modal-footer">
								<button type="button" class="btn btn-secondary" id = "btn_purchase7_modal_close">Close</button>
...
<script>
  var table = $("#dynamic-table7").DataTable({
	...
	$(document).on('click', '#btn_purchase7_modal_close',
		function() {
		$('#purchase7-modal').modal('toggle');
	});
</script>