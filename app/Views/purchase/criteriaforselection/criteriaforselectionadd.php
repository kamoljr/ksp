          ...
          <div class="panel-content" style = "padding:8px;">
              ...
              <div class="panel-content fourd-form-row-a" >
                <div class="form-row dialog-data " style = "padding-bottom:0px;">
                  ...
                  <div class="col-md-8 mb-8" style="padding-top:5px;padding-bottom:0px;font-size:13px;margin-bottom:0px !important;">
                    <input type="text" class="form-control form-ele clear-element" id="position_name" name="position_name" placeholder="หลักเกณฑ์การพิจารณาคัดเลือก" value="">
                  </div>
