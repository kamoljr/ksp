            ...
            <!-- Button trigger modal -->
							...
							<tbody>
								<tr>
									...
									<td >
										 <input type="text" class="form-control form-ele clear-element" id="position_name" name="position_name" placeholder="จัดสรร" value="" style = "width:60%;display:inline;"> กล่อง
									</td>
								...
								<tr>
									...
									<td >
										 <input type="text" class="form-control form-ele clear-element" id="position_name" name="position_name" placeholder="จัดสรร" value="" style = "width:60%;display:inline;"> อัน
									</td>
                ...
                <div class="col-md-10 mb-10" style="padding-top:5px;padding-bottom:0px;font-size:13px;margin-bottom:0px !important;">
                  <div class="">
                    <div class="custom-control custom-radio custom-control-inline" style ="line-height:25px;vertical-align: middle;">
                        ...
                        <label class="custom-control-label " for="defaultInline1Radio" >ยินยอม</label>
                    </div>
                 
                    <div class="custom-control custom-radio custom-control-inline" style ="line-height:25px;vertical-align: middle;">
                        <input type="radio" class="custom-control-input" id="defaultInline2Radio" name="inlineDefaultRadiosExample">
                        <label class="custom-control-label " for="defaultInline2Radio">จัดสรรแล้ว</label>
                    </div>
