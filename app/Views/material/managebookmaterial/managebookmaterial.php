                  ...
                  <div class="row" style = "padding-top:15px;">
                    ...
                    <div class="col-sm-3">
                     ...
                     <div class="col-sm-2">
                      ...
                      <input type="text" class="form-control form-ele clear-element" id="group_name_add" name="group_name_add" placeholder="รหัสขอจองวัสดุ" value="" >
                    </div>
                    <div class="col-sm-2">
                      <label class="form-label" for="group_name_search">
                        วันที่จอง
                      </label>
                      <input type="text" class="form-control form-ele clear-element datepk" id="group_name_add" name="group_name_add" placeholder="วันที่จอง" value="" >
                    </div>
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                 ...
                 <td>
                  <div class = "row" style = "padding-bottom:10px;">
                    <div class = "col-sm-9">ลวดเย็บกระดาษMAX เบอร์ 10	</div>
                    <div class = "col-sm-3">10 กล่อง</div>
                   
                    
                  </div>
                  <div class = "row" style = "padding-bottom:10px;">
                    <div class = "col-sm-9">แฟรชไดส์	</div>
                    <div class = "col-sm-3"> 5 อัน</div>
                ...
                <td>
                  <div class="custom-control custom-checkbox d-block bg-fusion-100" style = "padding-left:0px;padding-right:0px;margin:0px;padding-bottom:0px;padding-top:4px;">
                      <label ><small class= "">ยังไม่ได้ตรวจสอบ</small></label>
                  </div>
              ...
              <tr>
                ...
                <td>
                 ...
                 <td>
                 <div class = "row" style = "padding-bottom:10px;">
                    <div class = "col-sm-9">เชือกฟาง		</div>
                    
                    <div class = "col-sm-3">10 ม้วน</div>
                ...
                <td>
                  <div class="custom-control custom-checkbox d-block bg-warning-200" style = "padding-left:0px;padding-right:0px;margin:0px;padding-bottom:0px;padding-top:4px;">
                      <label ><small class= "">จัดหาไม่ได้</small></label>
                  </div>
                  <label style = "margin:0px;"><small class= "">(13 ก.ย. 65)</small></label>
                </td>
                <td>
              ...
              <tr>
                ...
                <td>
                 ...
                 <td>
                  <div class = "row" style = "padding-bottom:10px;">
                    <div class = "col-sm-9">กระดาษปกสี 120 แกรม (สีฟ้า,เขียว,เหลือง,ชมพู,ม่วง,โอรส,ครีม		</div>
                ...
                <td>
                  ...
                  <!-- <i class="fa-regular fa-hand bg-success-300" style = "padding:3px;padding-top:10px;"></i> -->
                  <!-- <label style = "margin:0px;"><small class= "">(13 ก.ย. 65)</small></label> -->
                  13 ก.ย. 65
                </td>
                <td>
                  <div class="custom-control custom-checkbox d-block bg-info-600" style = "padding-left:0px;padding-right:0px;margin:0px;padding-bottom:0px;padding-top:4px;">
                      <label ><small class= "">จัดหาได้</small></label>
                  </div>
                  <label style = "margin:0px;"><small class= "">(9 ส.ค 66)</small></label>
                </td>
                <td>
