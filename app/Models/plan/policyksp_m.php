...
class Policyksp_m extends Model
{
  ...
  {
    $sql = "Select strategyyear_id as field_id,budget_year as field_name From str_strategyyear where del_item = '0' order by budget_year desc";
  ...
  public function save_data()
  {
    ...
    $sql = "SELECT budget_year FROM str_strategyyear where strategyyear_id = ".$search_strategyyear_id;
    //echo $sql;
    $resultdellog = $this->db->query($sql)->getResultObject();
    $budget_year = $resultdellog[0]->budget_year;
    ...
    if ($ids == '') {
      ...
      $sql = "INSERT INTO str_policyksp (strategyyear_id,budget_year,policyksp,plantargetlvfour_id_multi,make_id,make_date,make_date_mktime) VALUES ($search_strategyyear_id,'$budget_year','$policyksp_add','$chk',$make_id,$make_date,'$make_date_mktime')";
      //echo $sql;
