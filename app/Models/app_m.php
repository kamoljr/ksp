...
class App_m extends Model
{
    ...
    public function getapp($pages = ''){
      $sql = "SELECT icon_system,mom_id,app_id,url,app_name,app_name_des,description.description ,app.description_id ,description.description_en FROM app inner join description on app.description_id = description.description_id Where url = '".$pages."'";
      //echo $sql;
